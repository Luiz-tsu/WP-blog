                ...
                <div class="royalbr-reset-options">
                    ...
                    <div class="royalbr-checkbox-card">
                        <label>
                            ...
                            <span class="royalbr-checkbox-content">
                                <span class="royalbr-checkbox-title"><?php esc_html_e('Restore Active Plugins', 'royal-backup-reset'); ?></span>
                            </span>
                        </label>
                    </div>
                            ...
                            <td>
                                <fieldset class="<?php echo $is_premium_settings ? '' : 'royalbr-pro-option-disabled'; ?>" <?php if ( ! $is_premium_settings ) : ?>data-pro-option-name="<?php esc_attr_e( 'Reset Preferences', 'royal-backup-reset' ); ?>"<?php endif; ?>>
                                    ...
                                    <label>
                                        ...
                                        <?php esc_html_e('Restore Active Plugins', 'royal-backup-reset'); ?>
                                    </label>
                                    <label>
                ...
                <section>
                    <table class="royalbr-feat-table">
                        <tbody>
                            ...
                            <!-- Feature: Cloud Storage (Coming Soon) -->
                            <tr>
                                <td>
                                    <h4><?php esc_html_e( 'Cloud Storage', 'royal-backup-reset' ); ?></h4>
                                    <p><?php esc_html_e( 'Store backups securely on Google Drive, Dropbox, Amazon S3, OneDrive, Azure, FTP, SFTP, and more remote locations.', 'royal-backup-reset' ); ?></p>
                                </td>
                                <td>
                                    <span class="dashicons dashicons-no-alt royalbr-no" aria-label="<?php esc_attr_e( 'No', 'royal-backup-reset' ); ?>"></span>
                                </td>
                            ...
                            <!-- Feature: WordPress Updates Protection (Coming Soon) -->
                            <tr>
                                <td>
                                    <h4><?php esc_html_e( 'WordPress Updates Protection', 'royal-backup-reset' ); ?></h4>
                                    <p><?php esc_html_e( 'The Backup will include Core WP files and If something goes wrong after a WP update, you can always revert back without losing your data.', 'royal-backup-reset' ); ?></p>
                                </td>
                                <td>
                                    <span class="dashicons dashicons-no-alt royalbr-no" aria-label="<?php esc_attr_e( 'No', 'royal-backup-reset' ); ?>"></span>
                                </td>
                            ...
                            <!-- Feature: Pre-Update Backups (Coming Soon) -->
                            <tr>
                                <td>
                                    <h4><?php esc_html_e( 'Pre-Update Backups', 'royal-backup-reset' ); ?></h4>
                                    <p><?php esc_html_e( 'Automatically create a backup before WordPress Core, Themes or Plugin updates.', 'royal-backup-reset' ); ?></p>
                                </td>
                                <td>
                                    <span class="dashicons dashicons-no-alt royalbr-no" aria-label="<?php esc_attr_e( 'No', 'royal-backup-reset' ); ?>"></span>
                                </td>
